...
// import {useChatList, ConversationDoc, timeAgo} from './useChatList';
// import {chatListStyles} from '../../styles/chatlistStyle';
// import {ICONS, IMAGES} from '../../constants/icons'; // Assuming LOADER is your loader icon or component
// import {COLORS} from '../../constants/colors';
...
//   const renderRightActions = (conversationId: string) => {
//     // Check if the conversation is being deleted.
...
import {Swipeable} from 'react-native-gesture-handler';
import GradientHeader from '../../components/gradientHeader/GradientHeader';
import {useChatList, ConversationDoc} from './useChatList';
import {chatListStyles} from '../../styles/chatlistStyle';
import {ICONS} from '../../constants/icons';
import {COLORS} from '../../constants/colors';
...
const ChatList: React.FC = () => {
  ...
  const renderRightActions = (conversationId: string) => {
    // If deletion is in progress, show Loader.
    if (deletingConversations.has(conversationId)) {
      return <Loader />;
    }
    return (
